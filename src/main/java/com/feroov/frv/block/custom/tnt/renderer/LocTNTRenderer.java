...
@OnlyIn(Dist.CLIENT)
public class LocTNTRenderer extends EntityRenderer<PrimedLoc>
{
    private final BlockRenderDispatcher blockRenderer;

    public LocTNTRenderer(EntityRendererProvider.Context p_174426_)
    {
        super(p_174426_);
    ...
    public void render(PrimedLoc primedVoid, float v, float v1, PoseStack poseStack, MultiBufferSource multiBufferSource, int i1)
    {
        poseStack.pushPose();
        ...
        poseStack.mulPose(Vector3f.YP.rotationDegrees(90.0F));
        TntMinecartRenderer.renderWhiteSolidBlock(this.blockRenderer, Blocks.AIR.defaultBlockState(), poseStack,
    ...
    public ResourceLocation getTextureLocation(PrimedLoc primedVoid)
    {
