...
public class EmeraldDetectorPrime extends Item
{
    public EmeraldDetectorPrime(Properties pProperties)
    {
        super(pProperties);
    }
    ...
    public InteractionResult useOn(UseOnContext pContext)
    {
        if(pContext.getLevel().isClientSide())
        {
            ...
            if(!foundBlock)
            {
                player.sendSystemMessage(Component.translatable("item.frv.emerald_detector.no_valuables"));
            }
        }
