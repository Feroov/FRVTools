...
public class RedstoneDetectorPrime extends Item
{
    public RedstoneDetectorPrime(Properties pProperties)
    {
        super(pProperties);
    }
    ...
    public InteractionResult useOn(UseOnContext pContext)
    {
        if(pContext.getLevel().isClientSide())
        {
            ...
            if(!foundBlock)
            {
                player.sendSystemMessage(Component.translatable("item.frv.redstone_detector.no_valuables"));
            }
        }
