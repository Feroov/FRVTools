...
public class GoldDetectorPrime extends Item
{
    public GoldDetectorPrime(Properties pProperties)
    {
        super(pProperties);
    }
    ...
    public InteractionResult useOn(UseOnContext pContext)
    {
        if(pContext.getLevel().isClientSide())
        {
            ...
            if(!foundBlock)
            {
                player.sendMessage(new TranslatableComponent("item.frv.gold_detector.no_valuables"),
                        player.getUUID());
            }
        }
