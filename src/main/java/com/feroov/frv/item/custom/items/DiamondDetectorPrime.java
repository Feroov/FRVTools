...
public class DiamondDetectorPrime extends Item
{
    public DiamondDetectorPrime(Properties pProperties)
    {
        super(pProperties);
    }
    ...
    public InteractionResult useOn(UseOnContext pContext)
    {
        if(pContext.getLevel().isClientSide())
        {
            ...
            if(!foundBlock)
            {
                player.sendMessage(new TranslatableComponent("item.frv.diamond_detector.no_valuables"),
                        player.getUUID());
            }
        }
