...
public class CoalDetector extends Item
{
    public CoalDetector(Properties pProperties)
    {
        super(pProperties);
    }
    ...
    public InteractionResult useOn(UseOnContext pContext)
    {
        if(pContext.getLevel().isClientSide())
        {
            ...
            if(!foundBlock)
            {
                player.sendMessage(new TranslatableComponent("item.frv.coal_detector.no_valuables"),
                        player.getUUID());
            }
        }
