...
public class MusketModel extends AnimatedGeoModel<Musket> {
	@Override
	public ResourceLocation getModelLocation(Musket object) {
		return new ResourceLocation(Frv.MOD_ID, "geo/musket.geo.json");
	}

	@Override
	public ResourceLocation getTextureLocation(Musket object) {
		return new ResourceLocation(Frv.MOD_ID, "textures/items/musket.png");
	}

	@Override
	public ResourceLocation getAnimationFileLocation(Musket animatable) {
