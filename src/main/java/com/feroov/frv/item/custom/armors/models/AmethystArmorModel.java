...
{
    @Override
    public ResourceLocation getModelResource(AmethystArmor object)
    {
        return new ResourceLocation(Frv.MOD_ID, "geo/amethyst_armor.geo.json");
    }

    @Override
    public ResourceLocation getTextureResource(AmethystArmor object)
    {
        return new ResourceLocation(Frv.MOD_ID, "textures/models/armor/amethyst_armor_layer_1.png");
    }

    @Override
    public ResourceLocation getAnimationResource(AmethystArmor animatable)
    {
