...
public class FRVStructuresMain extends Structure
{
    ...
    public Optional<Structure.GenerationStub> findGenerationPoint(Structure.GenerationContext context) {
        ...
        if (!FRVStructuresMain.extraSpawningChecks(context)) {
    ...
    {
        return FRVStructures.FRV_STRUCTURES.get(); // Helps the game know how to turn this structure back to json to save to chunks
    }
}