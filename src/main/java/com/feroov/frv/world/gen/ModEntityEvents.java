...
public class ModEntityEvents
{
    ...
    public static void onEntitySpawn(final BiomeLoadingEvent event)
    {
        ...
        /** Mimic **/
        addEntityToSpecificBiomes(event, ModEntityTypes.MIMIC.get(), 200, 1, 1, Biomes.PLAINS);
        addEntityToSpecificBiomes(event, ModEntityTypes.MIMIC.get(), 200, 1, 1, Biomes.DRIPSTONE_CAVES);
        addEntityToSpecificBiomes(event, ModEntityTypes.MIMIC.get(), 200, 1, 1, Biomes.LUSH_CAVES);
        addEntityToSpecificBiomes(event, ModEntityTypes.MIMIC.get(), 200, 1, 1, Biomes.DESERT);
        addEntityToSpecificBiomes(event, ModEntityTypes.MIMIC.get(), 200, 1, 1, Biomes.TAIGA);
    }
