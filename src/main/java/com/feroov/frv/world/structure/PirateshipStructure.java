...
public class PirateshipStructure extends StructureFeature<JigsawConfiguration>
{
    public PirateshipStructure(Codec<JigsawConfiguration> codec)
    {
        super(codec, PirateshipStructure::createPiecesGenerator, PostPlacementProcessor.NONE);
    }
    ...
    public static Optional<PieceGenerator<JigsawConfiguration>> createPiecesGenerator(PieceGeneratorSupplier.Context<JigsawConfiguration> context) {
        ...
        if (!PirateshipStructure.isFeatureChunk(context)) {
        ...
        JigsawConfiguration newConfig = new JigsawConfiguration(() -> context.registryAccess().ownedRegistryOrThrow(Registry.TEMPLATE_POOL_REGISTRY)
                .get(new ResourceLocation(Frv.MOD_ID, "pirate_ship/start_pool")), 10);
        ...
        if(structurePiecesGenerator.isPresent()) {
            ...
            Frv.LOGGER.log(Level.DEBUG, "Pirateship at " + blockpos);
        }
