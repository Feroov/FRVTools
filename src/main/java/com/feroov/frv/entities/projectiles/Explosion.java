...
public class Explosion extends Zombie implements IAnimatable
{

    public static final EntityDataAccessor<Integer> STATE = SynchedEntityData.defineId(Explosion.class, EntityDataSerializers.INT);
    private int lifeTicks = 55;
    ...
    {
        data.addAnimationController(new AnimationController<Explosion>
    ...
    public Explosion(EntityType<? extends Zombie> entityType, Level level)
    {
