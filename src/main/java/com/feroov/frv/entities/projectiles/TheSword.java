...
public class TheSword extends Zombie implements IAnimatable
{

    public static final EntityDataAccessor<Integer> STATE = SynchedEntityData.defineId(TheSword.class, EntityDataSerializers.INT);
    ...
    {
        data.addAnimationController(new AnimationController<TheSword>
    ...
    public TheSword(EntityType<? extends Zombie> p_i48549_1_, Level p_i48549_2_)
    {
    ...
    {
        this.playSound(ModSoundEvents.SILENT.get(), 0.0F, 0.0F);
        return null;
    }
    ...
    {
        this.playSound(ModSoundEvents.SILENT.get(), 7.0F, 0.0F);
        return null;
    }
