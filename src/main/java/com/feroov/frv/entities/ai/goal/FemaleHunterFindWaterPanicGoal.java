...
public class FemaleHunterFindWaterPanicGoal extends Goal
{
    private final FemaleHunter hunter;
    private final double speed;
    private double randPosX;
    private double randPosY;
    private double randPosZ;

    public FemaleHunterFindWaterPanicGoal(FemaleHunter hunter, double speedIn)
    {
        this.hunter = hunter;
        this.speed = speedIn;
