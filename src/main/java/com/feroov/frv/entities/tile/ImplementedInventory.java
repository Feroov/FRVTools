...
public interface ImplementedInventory extends Container
{
     ...
     */
    static ImplementedInventory of(NonNullList<ItemStack> items) { return () -> items; }

    /**
     * Creates a new inventory with the specified size.
     */
    static ImplementedInventory ofSize(int size) { return of(NonNullList.withSize(size, ItemStack.EMPTY)); }
     ...
     */
    @Override
    default ItemStack getItem(int slot) { return getItems().get(slot); }
     ...
     *              inventory ({@link Inventory#()}), it gets
