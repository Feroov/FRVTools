...
public class PirateCaptain extends Monster implements IAnimatable, RangedAttackMob
{
    ...
    /******************************** Constructor *************************************/
    public PirateCaptain(EntityType<? extends Monster> p_i48549_1_, Level p_i48549_2_)
    {
    ...
    protected void registerGoals()
    {
        ...
        this.goalSelector.addGoal(4, new PirateCaptainRangedAttackGoal(this, 0.35D, 20, 1.0F, 0)); // These are combined
    ...
    public void performRangedAttack(LivingEntity livingEntity, float p_32142_) {
        Melee arrow = new Melee(this.level, this);
