package com.feroov.frv.entities.trades;
...
public class CroakerAbstractVillagerEntity extends AgeableMob implements InventoryCarrier, Npc, Merchant
{
    private static final EntityDataAccessor<Integer> DATA_UNHAPPY_COUNTER =
            SynchedEntityData.defineId(CroakerAbstractVillagerEntity.class, EntityDataSerializers.INT);
    ...
    public CroakerAbstractVillagerEntity(EntityType<? extends CroakerAbstractVillagerEntity> p_35267_, Level p_35268_) {
