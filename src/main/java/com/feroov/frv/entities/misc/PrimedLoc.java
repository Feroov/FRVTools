...
public class PrimedLoc extends Entity
{
    private static final EntityDataAccessor<Integer> DATA_FUSE_ID = SynchedEntityData.defineId(PrimedLoc.class, EntityDataSerializers.INT);

    private static final int DEFAULT_FUSE_TIME = 10;

    @Nullable
    private LivingEntity owner;

    public PrimedLoc(Level level, double v, double v1, double v2, @Nullable LivingEntity livingEntity)
    {
        this(ModEntityTypes.PRIMED_LOC.get(), level);
        this.setPos(v, v1, v2);
    ...
    public PrimedLoc(EntityType<PrimedLoc> primedCorruptEntityType, Level level)
    {
